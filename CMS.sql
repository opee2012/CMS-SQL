...
SELECT POST.Created, POST.Title, POST.Content, PUSER.FName, PUSER.LName, PUSER.Email, COMMENT.Created, COMMENT.Content, USER.FName, USER.LName, USER.Email
FROM POST
JOIN USER AS PUSER
ON POST.UserID = PUSER.id
LEFT JOIN COMMENT
